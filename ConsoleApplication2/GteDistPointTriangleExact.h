...
public:
    ...
    Result operator()(Vector<N, Rational> const& point,
        Triangle<N, Rational> const& triangle);
};


template <int N, typename Rational>
typename DistancePointTriangleExact<N, Rational>::Result
DistancePointTriangleExact<N, Rational>::operator()(
    Vector<N, Rational> const& point, Triangle<N, Rational> const& triangle)
{
